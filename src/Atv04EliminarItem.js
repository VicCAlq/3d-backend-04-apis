/*
  ...
  * rota "DELETE" para o endereço "/api/beyblade/remover" após a rota
...
app.get('/api/beyblade/cadastrar', (req, res) => {
  ...
  db.all(
    ...
    `INSERT INTO selecao (nome, lamina, catraca, ponta, participante) VALUES (?, ?, ?, ?, ?)`,
    [nome, lamina, catraca, ponta, participante],
    ...
    (erro, itensDaTabela) => {
      ...
      res.json({
        message: `Beyblade ${nome} cadastrada com sucesso pelo participante ${participante}`,
        data: { id: this.lastID },
        id: this.lastID,
        total: itensDaTabela,
      });
...
app.delete('/api/beyblade/remover/:id', (req, res) => {
  ...
  db.all(
    ...
    (erro, itensDaTabela) => {
      ...
      res.json({
        message: `Participante removido da escalação.`,
        data: { id: this.lastID },
        id: this.lastID,
        total: itensDaTabela,
      });
